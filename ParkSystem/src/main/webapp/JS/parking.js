...
function startParking() {
  ...
  update(ctx, parseFloat(carPosition.x), parseFloat(carPosition.y), tagetX, tagetY)
}
...
function calculate() {
  ...
  if (minDistancePosition.direction == 'right') {
    ...
    ctx.lineTo(parseFloat(carPosition.x) - 660, parseFloat(carPosition.y) - 220)
    ctx.lineTo(parseFloat(carPosition.x) - 660, parseFloat(carPosition.y) - 100)
    ctx.lineTo(parseFloat(minDistancePosition.x) + 20, parseFloat(carPosition.y) - 100)
    if (minDistancePosition.orientation == "up") {
      ctx.lineTo(parseFloat(minDistancePosition.x) + 20, parseFloat(carPosition.y) - 60)
    } else {
      ctx.lineTo(parseFloat(minDistancePosition.x) + 20, parseFloat(carPosition.y) - 140)
    }
    ctx.stroke()
    ctx.closePath()
  }
